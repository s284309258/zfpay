...
$(document).ready(function(){
	...
	//多个手机号码验证,不同号码用,号隔开
	jQuery.validator.addMethod("isPhoneMultiple",function(value,element){
		var iphoneMultiple = value.split(";");
		for(var i=0;i<iphoneMultiple.length;i++){
			var phone=/^1[3|4|5|6|7|8|9][0-9]\d{8}$/;
			if(this.optional(element)||(phone.test(iphoneMultiple[i]))==false){
				return false;
			}
		}
		return true;
