 ...
 */
@Controller
@RequestMapping("/deveagent/summaryUserTraditionalPosBenefitEveryDay")
public class AgentSummaryUserTraditionalPosBenefitEveryDayController extends BaseController
{
    private String prefix = "deveagent/summaryUserTraditionalPosBenefitEveryDay";
	
	@Autowired
	private AgentSummaryUserTraditionalPosBenefitEveryDayService agentSummaryUserTraditionalPosBenefitEveryDayService;
	...
	{
	    return prefix + "/summaryUserTraditionalPosBenefitEveryDay";
	}
	...
	public TableDataInfo list(@RequestParam Map<String, Object> params)
	{
		...
		startPage();
		//根据条件分页查询用户列表
        List<Map<String, Object>> list = agentSummaryUserTraditionalPosBenefitEveryDayService.getAgentSummaryUserTraditionalPosBenefitEveryDayList(params);
        //处理响应请求分页数据
    ...
    {
    	List<AgentSummaryUserTraditionalPosBenefitEveryDay> list = agentSummaryUserTraditionalPosBenefitEveryDayService.selectAgentSummaryUserTraditionalPosBenefitEveryDayList(params);
