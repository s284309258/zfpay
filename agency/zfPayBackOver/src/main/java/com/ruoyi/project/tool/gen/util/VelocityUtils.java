...
public class VelocityUtils
{
    ...
    public static String getFileName(String template, GenTable genTable)
    {
        ...
        {
            fileName = StringUtil.format("{}/{}/domain/{}.java", javaPath, businessName, className);
        }
        else if (template.contains("mapper.java.vm"))
        {
            fileName = StringUtil.format("{}/{}/mapper/{}Mapper.java", javaPath, businessName, className);
        }
        else if (template.contains("service.java.vm"))
        {
            fileName = StringUtil.format("{}/{}/service/I{}Service.java", javaPath, businessName, className);
        }
        else if (template.contains("serviceImpl.java.vm"))
        {
            fileName = StringUtil.format("{}/{}/service/impl/{}ServiceImpl.java", javaPath, businessName, className);
        }
        else if (template.contains("controller.java.vm"))
        {
            fileName = StringUtil.format("{}/{}/controller/{}Controller.java", javaPath, businessName, className);
        }
        ...
        {
            fileName = StringUtil.format("{}/{}.html", htmlPath, businessName);
        }
        ...
        {
            fileName = StringUtil.format("{}/tree.html", htmlPath);
        }
