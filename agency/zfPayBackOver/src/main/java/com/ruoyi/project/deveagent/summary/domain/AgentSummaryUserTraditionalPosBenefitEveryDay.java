 ...
 * @date 2019-05-17
 */
public class AgentSummaryUserTraditionalPosBenefitEveryDay extends BaseEntity
{
	...
	public String toString() {
		return "AgentSummaryUserTraditionalPosBenefitEveryDay [id=" + id + ", manager_id=" + manager_id + ", user_id="
