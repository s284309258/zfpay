 ...
 */
@Service
public class AgentSysEposActivityInfoServiceImpl implements AgentSysEposActivityInfoService {
	...
	public List<Map<String, Object>> getAgentSysTraposActivityInfoList(Map<String, Object> params) {
		...
		return agentSysEposActivityInfoMapper.getAgentSysTraposActivityInfoList(params);
	}
	...
	public List<AgentSysTraposActivityInfo> selectAgentSysTraposActivityInfoList(Map<String, Object> params) {
		params.put("manager_id", ShiroUtils.getUserId());
		params.put("today_date", TimeUtil.getDayString());
		return agentSysEposActivityInfoMapper.selectAgentSysTraposActivityInfoList(params);
	}
	...
	public R addAgentSysTraposActivityInfo(Map<String, Object> params) {
		try {
			...
			i = agentSysEposActivityInfoMapper.addAgentSysTraposActivityInfo(params);
			if(i != 1) {
	...
	public Map<String, Object> getAgentSysTraposActivityInfoById(String id) {
		...
		return agentSysEposActivityInfoMapper.getAgentSysTraposActivityInfo(params);
	}
	...
	public R editAgentSysTraposActivityInfo(Map<String, Object> params) {
		try {
			...
			i = agentSysEposActivityInfoMapper.updateAgentSysTraposActivityInfo(params);
			if(i != 1) {
	...
	public R removeAgentSysTraposActivityInfo(Map<String, Object> activityMap) {
		try {
			int i = agentSysEposActivityInfoMapper.updateAgentSysTraposActivityInfoDel(activityMap);
			if(i != 1) {
	...
	public R releaseAgentSysTraposActivityInfo(Map<String, Object> activityMap) {
		try {
			...
			activityMap.put("manager_id", ShiroUtils.getUserId());//代理编号
			Map<String, Object> sameActivityMap = agentSysEposActivityInfoMapper.getAgentOnTraposActivitySameType(activityMap);
			...
			Map<String, Object> activityDetailMap = agentSysEposActivityInfoMapper.getAgentSysTraposActivityInfo(activityMap);
	    	...
	    	activityMap.put("up_date", TimeUtil.getDayString());//修改日期
	    	activityMap.put("up_time", TimeUtil.getTimeString());//修改时间
			i = agentSysEposActivityInfoMapper.updateAgentSysTraposActivityInfoStatus(activityMap);
			if(i!=1) {
	...
	public R noReleaseAgentSysTraposActivityInfo(Map<String, Object> activityMap) {
		try {
			...
			Integer apply_num = agentUserEposActivityApplyInfoMapper.getAgentUserTraposActivityApplyNum(activityMap.get("activity_id").toString());
			if(apply_num>0) {
