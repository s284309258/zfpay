 ...
 */
@Service
public class AgentUserMposUnbindServiceImpl extends BasicSerivce implements AgentUserMposUnbindService {

	@Autowired
	private AgentUserMposUnbindMapper agentUserMposUnbindMapper;
	 ...
	 */
	@Override
	public List<Map<String, Object>> getAgentUserMposUnbindList(Map<String, Object> params) {
		MapChainParams(params);
		return agentUserMposUnbindMapper.getAgentUserMposUnbindList(params);
	}
	...
	public R removePosBind(Map<String, Object> params) {
		...
		for(int ii=0;ii<unbind_ids.length;ii++) {
			...
			try {
				...
				Map<String, Object> unbindDetailMap = agentUserMposInfoMapper.getAgentUserMposInfoById(unbind_ids[ii]);
				//（3）更新该POS机的分配状态
