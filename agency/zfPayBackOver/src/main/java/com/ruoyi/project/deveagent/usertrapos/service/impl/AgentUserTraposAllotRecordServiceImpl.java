 ...
 */
@Service
public class AgentUserTraposAllotRecordServiceImpl extends BasicSerivce {
	
	
	@Autowired
	private AgentUserTraposAllotRecordMapper agentUserTraposAllotRecordMapper;
	...
	public List<Map<String, Object>> getAgentUserTraposAllotRecordList(Map<String, Object> params) {
		...
		params.put("pos_type","TraditionalPOS");
