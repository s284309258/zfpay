 ...
 * @date 2019-05-17
 */
public class AgentSummaryMposTransEveryDay extends BaseEntity
{
	...
	public String toString() {
		return "AgentSummaryMposTransEveryDay [id=" + id + ", manager_id=" + manager_id + ", user_id=" + user_id
				...
				+ ", agency_return_benefit=" + agency_return_benefit + ", cre_date=" + cre_date + "]";
	}
