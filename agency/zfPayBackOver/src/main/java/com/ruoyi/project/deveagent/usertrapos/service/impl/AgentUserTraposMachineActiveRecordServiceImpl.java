 ...
 */
@Service
public class AgentUserTraposMachineActiveRecordServiceImpl extends BasicSerivce {
	
	
	@Autowired
	private AgentUserTraposMachineActiveRecordMapper agentUserTroposRecordMapper;
