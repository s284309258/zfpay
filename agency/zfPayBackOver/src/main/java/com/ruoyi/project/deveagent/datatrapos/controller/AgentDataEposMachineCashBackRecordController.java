 ...
 */
@Controller
@RequestMapping("/deveagent/dataEposMachineCashBackRecord")
public class AgentDataEposMachineCashBackRecordController extends BaseController
{
    private String prefix = "deveagent/dataTraposMachineCashBackRecord";
	
	@Autowired
	private AgentDataEposMachineCashBackRecordService agentDataEposMachineCashBackRecordService;
	...
	{
	    return prefix + "/dataEposMachineCashBackRecord";
	}
	...
	public TableDataInfo list(@RequestParam Map<String, Object> params)
	{
		...
		startPage();
		//根据条件分页查询用户列表
        List<Map<String, Object>> list = agentDataEposMachineCashBackRecordService.getAgentDataTraposMachineCashBackRecordList(params);
        //处理响应请求分页数据
    ...
    {
    	List<AgentDataTraposMachineCashBackRecord> list = agentDataEposMachineCashBackRecordService.selectAgentDataTraposMachineCashBackRecordList(params);
