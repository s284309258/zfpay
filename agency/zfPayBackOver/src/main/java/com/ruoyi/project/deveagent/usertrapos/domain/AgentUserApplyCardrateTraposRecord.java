 ...
 * @date 2019-05-17
 */
public class AgentUserApplyCardrateTraposRecord extends BaseEntity
{
	...
	public String toString() {
		return "AgentUserApplyCardrateTraposRecord [id=" + id + ", manager_id=" + manager_id + ", user_id=" + user_id
