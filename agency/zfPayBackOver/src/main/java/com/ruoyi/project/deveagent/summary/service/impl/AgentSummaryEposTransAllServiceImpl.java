 ...
 */
@Service
public class AgentSummaryEposTransAllServiceImpl extends BasicSerivce implements AgentSummaryEposTransAllService {
	...
	public Map<String, Object> summaryTraditionalPosTransAllList(Map<String, Object> params) {
		MapChainParams(params);
		return agentSummaryEposTransAllMapper.summaryTraditionalPosTransAllList(params);
	}
