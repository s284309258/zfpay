 ...
 * @date 2019-05-17
 */
public class AgentSummaryTraditionalPosTransMonth extends BaseEntity
{
	...
	public String toString() {
		return "AgentSummaryTraditionalPosTransMonth [id=" + id + ", manager_id=" + manager_id + ", user_id=" + user_id
