...
@Controller
@RequestMapping("/deveagent/userTraposMachineActiveRecord")
public class AgentUserTraposMachineActiveRecordController extends BaseController {

    private String prefix = "deveagent/userTraposMachineActiveRecord";

    @Autowired
    private AgentUserTraposMachineActiveRecordServiceImpl agentUserTraposRecordService;
    ...
    public TableDataInfo list(@RequestParam Map<String, Object> params)
    {
        ...
        startPage();
        //根据条件分页查询用户列表
        List<Map<String, Object>> list = agentUserTraposRecordService.getAgentUserTroposRecordList(params);
        //处理响应请求分页数据
    ...
    {
        List<AgentUserMposMachineActiveRecord> list = agentUserTraposRecordService.selectAgentUserTroposRecordList(params);
        ...
        return util.exportExcel(list, "传统POS激活记录数据");
    }
