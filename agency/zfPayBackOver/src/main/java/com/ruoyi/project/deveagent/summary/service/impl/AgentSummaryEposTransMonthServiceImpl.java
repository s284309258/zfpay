 ...
 */
@Service
public class AgentSummaryEposTransMonthServiceImpl extends BasicSerivce implements AgentSummaryEposTransMonthService {
	...
	public Map<String, Object> summaryTraditionalPosTransAllList(Map<String, Object> params) {
		MapChainParams(params);
		return agentSummaryEposTransMonthMapper.summaryTraditionalPosTransAllList(params);
	}
