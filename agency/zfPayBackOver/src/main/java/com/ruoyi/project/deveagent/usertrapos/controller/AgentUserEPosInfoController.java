 ...
 */
@Controller
@RequestMapping("/deveagent/userEposInfo")
public class AgentUserEPosInfoController extends BaseController
{
    private String prefix = "deveagent/userEposInfo";
...
//	@RequiresPermissions("deveagent:userTraditionalPosInfo:list")
	...
	public TableDataInfo list(@RequestParam Map<String, Object> params)
	{
		...
		startPage();
		//根据条件分页查询用户列表
        List<Map<String, Object>> list = agentUserEPosInfoService.getAgentUserTraditionalPosInfoList(params);
        //处理响应请求分页数据
...
//	@RequiresPermissions("deveagent:userTraditionalPosInfo:export")
    ...
    {
    	List<AgentUserTraditionalPosInfo> list = agentUserEPosInfoService.selectAgentUserTraditionalPosInfoList(params);
...
//    		return "redirect:/system/user/profile/toIsAuth?id="+id+"&operParam="+operParam+"&bus_type="+VerifyConstant.AuthVerfiy_AgentAddUserEposInfo;
//    	}else {
    		mmap.put("id", id);
...
//    	}
    ...
    {
//        if(!ShiroUtils.getSysUser().isAuth()) {
//            return "redirect:/system/user/profile/toIsAuth?id="+id+"&operParam="+operParam+"&bus_type="+VerifyConstant.AuthVerfiy_AgentAddUserAgentEposInfo;
//        }else {
            mmap.put("id", id);
...
//        }
    ...
    {
        mmap.put("user_id", id);
        List<Map<String,Object>> dropDownList = agentUserEPosInfoService.selectSubAgentInfo(id);
    ...
    {
		mmap.put("user_id", id);
//        List<Map<String,Object>> policyList = sysPosPolicyService.selectSysPosPolicy2(null);
//        mmap.addAttribute("policyList",policyList);
...
//    @RequiresPermissions("deveagent:userTraditionalPosInfo:import")
    ...
    public R importData(MultipartFile file, String user_id) throws Exception
    {
        ...
        //导入用户传统POS数据信息
        return agentUserEPosInfoService.importAgentUserTraditionalPosInfoList(agentuserTraditionalPosInfoList,user_id);
    }
...
//	@RequiresPermissions("deveagent:userTraditionalPosInfo:add")
    ...
    {
    	List<AgentSelectUserTraditionalPosInfo> list = agentUserEPosInfoService.selectAgentNoDisSysTraditionalPosInfoList(params);
...
//    @RequiresPermissions("deveagent:userTraditionalPosInfo:add")
    ...
    {
    	return agentUserEPosInfoService.addAgentUserTraditionalPosInfo(params);
    }
...
//    @RequiresPermissions("deveagent:userMposInfo:add")
    ...
    public R subAdd(@RequestParam Map<String, Object> params){
        return agentUserEPosInfoService.addSubAgentUserTraditionalPosInfo(params);
    }
...
//    @RequiresPermissions("deveagent:userTraditionalPosInfo:list")
    ...
    {
        return agentUserEPosInfoService.getAgentUserTraditionalPosInfoById(id);
    }
...
//    @RequiresPermissions("deveagent:userTraditionalPosInfo:edit")
    ...
    {
        return agentUserEPosInfoService.editAgentUserTraditionalPosInfo(params);
    }
