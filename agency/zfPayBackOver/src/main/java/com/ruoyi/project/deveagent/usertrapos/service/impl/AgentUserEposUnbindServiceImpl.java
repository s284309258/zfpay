...
import com.ruoyi.project.deveagent.usertrapos.mapper.AgentUserEposUnbindMapper;
 ...
 */
@Service
public class AgentUserEposUnbindServiceImpl implements AgentUserEposUnbindService {

	@Autowired
	private AgentUserEposUnbindMapper agentUserEposUnbindMapper;
	...
	public List<Map<String, Object>> getAgentUserTraposUnbindList(Map<String, Object> params) {
		...
		return agentUserEposUnbindMapper.getAgentUserTraposUnbindList(params);
	}
