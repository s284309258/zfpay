 ...
 * @date 2019-05-17
 */
public class AgentSysMposInfo extends BaseEntity
{
	...
	public String toString() {
		return "AgentSysMposInfo [id=" + id + ", manager_id=" + manager_id + ", account_id=" + account_id + ", app_id="
				+ app_id + ", sn=" + sn + ", mer_id=" + mer_id + ", mer_name=" + mer_name + ", name=" + name + ", tel="
				+ tel + ", cash_back_type=" + cash_back_type + ", cash_back_condition=" + cash_back_condition
				...
				+ ", cloud_flash_rate=" + cloud_flash_rate + ", act_status=" + act_status + ", dis_status=" + dis_status
				+ ", act_user_id=" + act_user_id + ", act_date=" + act_date + ", cre_date=" + cre_date + ", cre_time="
				+ cre_time + ", up_date=" + up_date + ", remark=" + remark + ", create_by=" + create_by + ", update_by="
				+ update_by + "]";
	}
