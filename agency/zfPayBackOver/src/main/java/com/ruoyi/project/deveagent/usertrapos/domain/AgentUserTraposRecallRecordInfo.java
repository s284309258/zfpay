 ...
 * @date 2019-05-17
 */
public class AgentUserTraposRecallRecordInfo extends BaseEntity
{
	...
	public String toString() {
		return "AgentUserTraposRecallRecordInfo [id=" + id + ", manager_id=" + manager_id + ", send_user_id="
				...
				+ acce_user_tel + ", sn=" + sn + ", status=" + status + ", cre_date=" + cre_date + ", up_date="
				+ up_date + "]";
	}
