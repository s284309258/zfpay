 ...
 * @date 2019-05-17
 */
public class AgentUserMposShareBenefitRecord extends BaseEntity
{
	...
	public String toString() {
		return "AgentUserMposShareBenefitRecord [id=" + id + ", order_id=" + order_id + ", manager_id=" + manager_id
				...
				+ tran_ref_code + ", card_settle_price=" + card_settle_price + ", cloud_settle_price="
				+ cloud_settle_price + ", weixin_settle_price=" + weixin_settle_price + ", zhifubao_settle_price="
				+ zhifubao_settle_price + ", single_profit_rate=" + single_profit_rate + ", credit_card_rate="
				+ credit_card_rate + ", cloud_flash_rate=" + cloud_flash_rate + ", weixin_rate=" + weixin_rate
				+ ", zhifubao_rate=" + zhifubao_rate + ", mer_cap_fee=" + mer_cap_fee + ", trade_mer_cap_fee="
				+ trade_mer_cap_fee + ", cre_date=" + cre_date + "]";
	}
