 ...
 * @date 2019-05-17
 */
public class AgentSummaryTraditionalPosTransAll extends BaseEntity
{
	...
	public String toString() {
		return "AgentSummaryTraditionalPosTransAll [id=" + id + ", manager_id=" + manager_id + ", user_id=" + user_id
				...
				+ ", agency_return_benefit=" + agency_return_benefit + ", up_date=" + up_date + "]";
	}
