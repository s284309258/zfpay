 ...
 */
@Controller
@RequestMapping("/deveagent/userEposRecallHandle")
public class AgentUserEposRecallHandleController extends BaseController
{
	...
	{
	    return prefix + "/userTraditionalPosRecallHandle";
	}
	...
	public TableDataInfo list(@RequestParam Map<String, Object> params)
	{
        ...
        List<Map<String, Object>> list = agentUserTraditionalPosInfoService.getAgentUserTraditionalPosRecallHandleList(params);
        //处理响应请求分页数据
    ...
    public String recallUserPos(@RequestParam Map<String, Object> params){
        int cnt = agentUserTraditionalPosInfoService.recallUserPos(params);
        if(cnt>0){
            return "success";
        }
        return "fail";
    ...
    public String agreeRecallUserPos(@RequestParam Map<String, Object> params){
        int cnt = agentUserTraditionalPosInfoService.agreeRecallUserPos(params);
        if(cnt>0){
            return "success";
        }
        return "fail";
    ...
    public String refuseRecallUserPos(@RequestParam Map<String, Object> params){
        int cnt = agentUserTraditionalPosInfoService.refuseRecallUserPos(params);
        if(cnt>0){
            return "success";
        }
        return "fail";
