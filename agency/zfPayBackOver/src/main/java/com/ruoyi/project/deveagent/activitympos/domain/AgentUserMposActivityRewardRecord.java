 ...
 * @date 2019-05-17
 */
public class AgentUserMposActivityRewardRecord extends BaseEntity
{
	...
	public String toString() {
		return "AgentUserMposActivityRewardRecord [id=" + id + ", order_id=" + order_id + ", manager_id=" + manager_id
