...
public class AgentSummaryMposTransEveryDayController extends BaseController
{
	...
	@PostMapping("/summaryMposTransAllList")
	@ResponseBody
	public Map<String,Object> summaryMposTransAllList(@RequestParam Map<String, Object> params){
		return agentSummaryMposTransEveryDayService.summaryMposTransAllList(params);
	}
	/**
	 * 查询MPOS商户数据汇总(每日)列表
	 */
