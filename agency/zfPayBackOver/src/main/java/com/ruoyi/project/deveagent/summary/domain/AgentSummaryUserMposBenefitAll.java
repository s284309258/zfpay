 ...
 * @date 2019-05-17
 */
public class AgentSummaryUserMposBenefitAll extends BaseEntity
{
	...
	public String toString() {
		return "AgentSummaryUserMposBenefitAll [id=" + id + ", manager_id=" + manager_id + ", user_id=" + user_id
				+ ", user_tel=" + user_tel + ", real_name=" + real_name + ", performance=" + performance + ", num="
				+ num + ", merchant_performance=" + merchant_performance + ", merchant_num=" + merchant_num
				...
				+ ", merchant_trade_num=" + merchant_trade_num + ", agency_trade_num=" + agency_trade_num + ", up_date="
				+ up_date + "]";
	}
