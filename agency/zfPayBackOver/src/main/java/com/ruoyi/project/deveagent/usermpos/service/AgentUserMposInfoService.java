...
public interface AgentUserMposInfoService {
	...
	List<Map<String, Object>> getAgentUserMposRecallList(Map<String, Object> params);


	List<Map<String, Object>> getAgentUserMposRecallHandleList(Map<String,Object> params);
