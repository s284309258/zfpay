...
public interface AgentUserTraditionalPosInfoService {
	...
	List<Map<String, Object>> getAgentUserTraditionalPosRecallList(Map<String, Object> params);


	List<Map<String, Object>> getAgentUserTraditionalPosRecallHandleList(Map<String, Object> params);


	int recallUserPos(Map<String, Object> params);


	int agreeRecallUserPos(Map<String, Object> params);


	int refuseRecallUserPos(Map<String,Object> params);
