...
public class LoginController extends BaseController
{
    ...
    public AjaxResult ajaxLogin(String username, String password, Boolean rememberMe)
    {
        ...
        try
        {
            ...
            AgentUserInfo agentUserInfo = agentUserInfoMapper.selectUserInfoAllByTel(username);
            session.setAttribute(Constants.AgentUserInfo,agentUserInfo);
            session.setAttribute("real_name",agentUserInfo.getReal_name());
            session.setAttribute("label",agentUserInfo.getLabel());
            return success();
