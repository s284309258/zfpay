 ...
 */
@Service
public class AgentUserTraditionalPosInfoServiceImpl extends BasicSerivce implements AgentUserTraditionalPosInfoService {
	...
	@Override
	public List<Map<String, Object>> getAgentUserTraditionalPosRecallList(Map<String, Object> params) {
		MapChainParams(params);
		return agentUserTraditionalPosInfoMapper.getAgentUserTraditionalPosRecallList(params);
	}

	@Override
	public List<Map<String, Object>> getAgentUserTraditionalPosRecallHandleList(Map<String, Object> params) {
		MapChainParams(params);
		return agentUserTraditionalPosInfoMapper.getAgentUserTraditionalPosRecallHandleList(params);
	}

	@Override
	public int recallUserPos(Map<String, Object> params) {
		MapChainParams(params);
		return agentUserTraditionalPosInfoMapper.recallUserPos(params);
	}

	@Override
	public int agreeRecallUserPos(Map<String, Object> params) {
		MapChainParams(params);
		return agentUserTraditionalPosInfoMapper.agreeRecallUserPos(params);
	}

	@Override
	public int refuseRecallUserPos(Map<String, Object> params) {
		MapChainParams(params);
		return agentUserTraditionalPosInfoMapper.refuseRecallUserPos(params);
	}
...
//			sysPosPolicyService.insertPolicySNInfo(String.valueOf(params.get("policy")),params.get("pos_sns").toString(),params.get("user_id").toString(),"TraditionalPOS");
	...
	public R addSingleAgentUserTraditionalPosInfo(AgentUserTraditionalPosInfo agentUserTraditionalPosInfo) {
		try {
			...
			Map<String, Object> basePrice = agentUserTraditionalPosInfoMapper.getAgentUserTraditionalPosInfo(allot);
