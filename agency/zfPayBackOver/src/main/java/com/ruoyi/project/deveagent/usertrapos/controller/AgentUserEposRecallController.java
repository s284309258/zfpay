 ...
 */
@Controller
@RequestMapping("/deveagent/userEposRecall")
public class AgentUserEposRecallController extends BaseController
{
	...
	{
	    return prefix + "/userTraditionalPosRecall";
	}
	...
	public TableDataInfo list(@RequestParam Map<String, Object> params)
	{
        ...
        List<Map<String, Object>> list = agentUserTraditionalPosInfoService.getAgentUserTraditionalPosRecallList(params);
        //处理响应请求分页数据
