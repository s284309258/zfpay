 ...
 * @date 2019-05-17
 */
public class AgentSummaryUserMposBenefitEveryDay extends BaseEntity
{
	...
	public String toString() {
		return "AgentSummaryUserMposBenefitEveryDay [id=" + id + ", manager_id=" + manager_id + ", user_id=" + user_id
