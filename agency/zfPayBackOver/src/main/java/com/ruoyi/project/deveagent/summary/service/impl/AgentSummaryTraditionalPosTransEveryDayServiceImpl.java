 ...
 */
@Service
public class AgentSummaryTraditionalPosTransEveryDayServiceImpl extends BasicSerivce implements AgentSummaryTraditionalPosTransEveryDayService {
	...
	public Map<String, Object> summaryTraditionalPosTransAllList(Map<String, Object> params) {
		MapChainParams(params);
		return agentSummaryTraditionalPosTransEveryDayMapper.summaryTraditionalPosTransAllList(params);
	}
