...
public class TimeUtil {
	...
	/**
	 * 获取昨天日期 格式：2018-11-15
	 * @return
	 */
	public static String getYesterdayFormat3(){
		Calendar cal=Calendar.getInstance();
		cal.setTime(new Date());//当天开始时间
   ...
   */
     ...
     */
    public static String getBankCutDate(String time) throws Exception{
		Calendar cal0 = Calendar.getInstance();
		cal0.setTime(format4.parse(time));
    	cal0.set(Calendar.HOUR_OF_DAY, 23);
    	cal0.set(Calendar.MINUTE, 0);
    	cal0.set(Calendar.SECOND, 0);
    	return format4.format(cal0.getTime());
     ...
     * @return yyyyMMddHHmmss
     */
    public static String getYesterdayBankCutDate(String time) throws Exception{
		Calendar cal0 = Calendar.getInstance();
		cal0.setTime(format4.parse(time));
     ...
     * @return yyyyMMddHHmmss
     */
    public static String getBeforeTwoDayBankCutDate(String time) throws Exception{
		Calendar cal0 = Calendar.getInstance();
		cal0.setTime(format4.parse(time));
	 ...
	 * @return yyyyMMddHHmmss
	 */
	public static String getBeforeTwoDayBankCutDate(String time,int day) throws Exception{
		Calendar cal0 = Calendar.getInstance();
		cal0.setTime(format4.parse(time));
		cal0.add(Calendar.DAY_OF_YEAR, day);
		cal0.set(Calendar.HOUR_OF_DAY, 23);
		cal0.set(Calendar.MINUTE, 0);
		cal0.set(Calendar.SECOND, 0);
		return format4.format(cal0.getTime());
     ...
     * @return
     */
    public static String getBeforeTenMinute(String time)throws Exception{
    	Calendar calendar = Calendar.getInstance();
    	calendar.setTime(format4.parse(time));
    ...
    public static void main(String[] args) {
		try {
			System.out.println(getYesterdayFormat3());
		} catch (Exception e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		}
