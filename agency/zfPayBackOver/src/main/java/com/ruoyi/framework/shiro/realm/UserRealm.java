...
public class UserRealm extends AuthorizingRealm
{
    ...
    protected AuthorizationInfo doGetAuthorizationInfo(PrincipalCollection arg0)
    {
        ...
        AgentUserInfo agentUserInfo = agentUserInfoMapper.selectUserInfoAllByTel(ShiroUtils.getLoginName());
        ...
        if (user.isAdmin())
        {
            info.addRole("admin");//赋予管理员角色
            info.addStringPermission("*:*:*");//赋予所有权限
        }else{
        	//否则查询对应角色列表信息
