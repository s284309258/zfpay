 ...
 */
@Service
public class AgentSysTraposActivityRewardInfoServiceImpl implements AgentSysTraposActivityRewardInfoService {
	...
	@Autowired
	private AgentSysTraposActivityRewardInfoMapper agentSysTraposActivityRewardInfoMapper;
	...
	public List<Map<String, Object>> getAgentSysTraposActivityRewardInfoList(Map<String, Object> params) {
		...
		return agentSysTraposActivityRewardInfoMapper.getAgentSysTraposActivityRewardInfoList(params);
	}
	...
	public List<AgentSysTraposActivityRewardInfo> selectAgentSysTraposActivityRewardInfoList(Map<String, Object> params) {
		params.put("manager_id", ShiroUtils.getUserId());
		return agentSysTraposActivityRewardInfoMapper.selectAgentSysTraposActivityRewardInfoList(params);
	}
	...
	public R addAgentSysTraposActivityRewardInfos(Map<String, Object> params) {
		try {
			...
			//根据活动id查询活动详情
			Map<String, Object> activityInfo = agentSysTraposActivityInfoMapper.getAgentSysTraposActivityInfoById(params.get("activity_id").toString());
	...
	public R addAgentSysTraposActivityRewardInfo(Map<String, Object> activityRewardMap) {
		try {
			int i = agentSysTraposActivityRewardInfoMapper.addAgentSysTraposActivityRewardInfo(activityRewardMap);
			if(i != 1) {
	...
	public Map<String, Object> getAgentSysTraposActivityRewardInfoById(String id) {
		return agentSysTraposActivityRewardInfoMapper.getAgentSysTraposActivityRewardInfoById(id);
	}
	...
	public R editAgentSysTraposActivityRewardInfo(Map<String, Object> params) {
		try {
			...
			int i=0;
			//（1）查询old参数信息
			Map<String, Object> oldValue = agentSysTraposActivityRewardInfoMapper.getAgentSysTraposActivityRewardInfoById(params.get("reward_id").toString());
			//（2）更新
			...
			i = agentSysTraposActivityRewardInfoMapper.updateAgentSysTraposActivityRewardInfo(params);
			if(i != 1) {
				return R.error(Type.WARN, "更新失败");
			}
			//（3）查询new参数信息
			Map<String, Object> newValue = agentSysTraposActivityRewardInfoMapper.getAgentSysTraposActivityRewardInfoById(params.get("reward_id").toString());
			//（4）记录修改记录
	...
	public R removeAgentSysTraposActivityRewardInfo(Map<String, Object> activityRewardMap) {
		try {
			int i=0;
			//（1）查询old参数信息
			Map<String, Object> oldValue = agentSysTraposActivityRewardInfoMapper.getAgentSysTraposActivityRewardInfoById(activityRewardMap.get("reward_id").toString());
			//（2）更新状态
			...
			i = agentSysTraposActivityRewardInfoMapper.updateAgentSysTraposActivityRewardInfoDel(activityRewardMap);
			if(i != 1) {
				return R.error(Type.WARN, "活动(传统POS)奖励编号"+activityRewardMap.get("reward_id").toString()+"：删除失败，只能删除待发布未删除的活动");
			}
			//（3）查询new参数信息
			Map<String, Object> newValue = agentSysTraposActivityRewardInfoMapper.getAgentSysTraposActivityRewardInfoById(activityRewardMap.get("reward_id").toString());
			//（4）记录修改记录
