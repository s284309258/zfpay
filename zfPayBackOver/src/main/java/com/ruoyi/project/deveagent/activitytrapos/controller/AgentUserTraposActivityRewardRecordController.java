 ...
 */
@Controller
@RequestMapping("/deveagent/userTraposActivityRewardRecord")
public class AgentUserTraposActivityRewardRecordController extends BaseController
{
    private String prefix = "deveagent/userTraposActivityRewardRecord";
	
	@Autowired
	private AgentUserTraposActivityRewardRecordService agentUserTraposActivityRewardRecordService;
	...
	public TableDataInfo list(@RequestParam Map<String, Object> params)
	{
		...
		startPage();
		//根据条件分页查询用户列表
        List<Map<String, Object>> list = agentUserTraposActivityRewardRecordService.getAgentUserTraposActivityRewardRecordList(params);
        //处理响应请求分页数据
    ...
    {
    	List<AgentUserTraposActivityRewardRecord> list = agentUserTraposActivityRewardRecordService.selectAgentUserTraposActivityRewardRecordList(params);
