...
public class AgentUserReportRecordServiceImpl implements AgentUserReportRecordService {
	...
	public R sysReport(Map<String, Object> params) {
		try {
			...
			Base64Utils.Base64ToImage(subAgentIdImg,"D:\\subAgentIdImg.jpg");
			//（5）请求数据对象
...
//				}else{
				...
				Base64Utils.Base64ToImage(cardImg2,"D:\\cardImg2.jpg");
				...
				Base64Utils.Base64ToImage(subAgentIdImg3,"D:\\subAgentIdImg3.jpg");
