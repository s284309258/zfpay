 ...
 * @date 2019-05-17
 */
public class AgentSummaryUserTraditionalPosBenefitAll extends BaseEntity
{
	...
	public String toString() {
		return "AgentSummaryUserTraditionalPosBenefitAll [id=" + id + ", manager_id=" + manager_id + ", user_id="
