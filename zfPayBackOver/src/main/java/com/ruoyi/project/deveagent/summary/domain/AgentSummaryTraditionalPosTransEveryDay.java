 ...
 * @date 2019-05-17
 */
public class AgentSummaryTraditionalPosTransEveryDay extends BaseEntity
{
	...
	public String toString() {
		return "AgentSummaryTraditionalPosTransEveryDay [id=" + id + ", manager_id=" + manager_id + ", user_id="
				+ user_id + ", user_tel=" + user_tel + ", real_name=" + real_name + ", sn=" + sn + ", performance="
				+ performance + ", num=" + num + ", merchant_performance=" + merchant_performance + ", merchant_num="
				+ merchant_num + ", agency_performance=" + agency_performance + ", agency_num=" + agency_num
				+ ", benefit=" + benefit + ", share_benefit=" + share_benefit + ", single_benefit=" + single_benefit
				+ ", return_benefit=" + return_benefit + ", activity_benefit=" + activity_benefit
				+ ", merchant_benefit=" + merchant_benefit + ", merchant_share_benefit=" + merchant_share_benefit
				+ ", merchant_single_benefit=" + merchant_single_benefit + ", merchant_return_benefit="
				+ merchant_return_benefit + ", merchant_activity_benefit=" + merchant_activity_benefit
				+ ", agency_benefit=" + agency_benefit + ", agency_share_benefit=" + agency_share_benefit
				+ ", agency_single_benefit=" + agency_single_benefit + ", agency_return_benefit="
				+ agency_return_benefit + ", cre_date=" + cre_date + "]";
	}
