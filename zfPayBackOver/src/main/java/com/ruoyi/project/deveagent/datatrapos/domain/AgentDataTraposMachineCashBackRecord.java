 ...
 * @date 2019-05-17
 */
public class AgentDataTraposMachineCashBackRecord extends BaseEntity
{
	...
	public String toString() {
		return "AgentDataMposMachineCashBackRecord [id=" + id + ", manager_id=" + manager_id + ", sn=" + sn
				...
				+ account_id + ", app_id=" + app_id + ", cre_date=" + cre_date + "]";
	}
