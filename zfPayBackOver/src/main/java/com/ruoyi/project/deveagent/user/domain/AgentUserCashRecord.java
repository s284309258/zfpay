 ...
 * @date 2019-05-17
 */
public class AgentUserCashRecord extends BaseEntity
{
	...
	public String toString() {
		return "AgentUserCashRecord [id=" + id + ", order_id=" + order_id + ", manager_id=" + manager_id + ", user_id="
				+ user_id + ", user_tel=" + user_tel + ", real_name=" + real_name + ", org_no=" + org_no + ", org_name="
				+ org_name + ", account_type=" + account_type + ", cash_money=" + cash_money + ", cash_actual_money="
				+ cash_actual_money + ", feet_rate=" + feet_rate + ", rate_feet_money=" + rate_feet_money
				+ ", single_feet_money=" + single_feet_money + ", deduct_money=" + deduct_money + ", account=" + account
				+ ", account_name=" + account_name + ", id_card=" + id_card + ", bank_code=" + bank_code
				+ ", bank_name=" + bank_name + ", batch_no=" + batch_no + ", status=" + status + ", cre_date="
				+ cre_date + ", up_date=" + up_date + ", update_by=" + update_by + ", remark=" + remark + "]";
	}
