 ...
 */
@Controller
@RequestMapping("/deveagent/summaryUserTraditionalPosBenefitAll")
public class AgentSummaryUserTraditionalPosBenefitAllController extends BaseController
{
    private String prefix = "deveagent/summaryUserTraditionalPosBenefitAll";
	
	@Autowired
	private AgentSummaryUserTraditionalPosBenefitAllService agentSummaryUserTraditionalPosBenefitAllService;
	...
	{
	    return prefix + "/summaryUserTraditionalPosBenefitAll";
	}
	...
	public TableDataInfo list(@RequestParam Map<String, Object> params)
	{
		...
		startPage();
		//根据条件分页查询用户列表
        List<Map<String, Object>> list = agentSummaryUserTraditionalPosBenefitAllService.getAgentSummaryUserTraditionalPosBenefitAllList(params);
        //处理响应请求分页数据
    ...
    {
    	List<AgentSummaryUserTraditionalPosBenefitAll> list = agentSummaryUserTraditionalPosBenefitAllService.selectAgentSummaryUserTraditionalPosBenefitAllList(params);
