 ...
 */
@Service
public class AgentUserTraposActivityApplyInfoServiceImpl implements AgentUserTraposActivityApplyInfoService {
	...
	public List<Map<String, Object>> getAgentUserTraposActivityApplyInfoList(Map<String, Object> params) {
		...
		return agentUserTraposActivityApplyInfoMapper.getAgentUserTraposActivityApplyInfoList(params);
	}
	...
	public List<AgentUserTraposActivityApplyInfo> selectAgentUserTraposActivityApplyInfoList(Map<String, Object> params) {
		params.put("manager_id", ShiroUtils.getUserId());
		return agentUserTraposActivityApplyInfoMapper.selectAgentUserTraposActivityApplyInfoList(params);
	}
	...
	public Map<String, Object> getAgentUserTraposActivityApplyInfoDetailById(String id) {
		return agentUserTraposActivityApplyInfoMapper.getAgentUserTraposActivityApplyInfoDetailById(id);
	}
	...
	public R acceptAgentUserTraposActivityApplyInfo(Map<String, Object> activityApplyMap) {
		try {
			...
			i = agentUserTraposActivityApplyInfoMapper.updateAgentUserTraposActivityApplyInfoStatus(activityApplyMap);
			if(i!=1) {
	...
	public R refuseAgentUserTraposActivityApplyInfo(Map<String, Object> activityApplyMap) {
		try {
			...
			//（2）查询详情，获取sn_list
			Map<String, Object> applyDetailMap = agentUserTraposActivityApplyInfoMapper.getAgentUserTraposActivityApplyInfoMapById(activityApplyMap.get("apply_id").toString());
			//（3）更新用户pos机的参与活动状态
