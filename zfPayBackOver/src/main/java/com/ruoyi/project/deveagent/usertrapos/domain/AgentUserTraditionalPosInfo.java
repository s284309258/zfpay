 ...
 * @date 2019-05-17
 */
public class AgentUserTraditionalPosInfo extends BaseEntity
{
	...
	/** 微信费率（%） */
	@Excel(name = "微信费率（%）", type = Type.EXPORT)
	private String weixin_rate;
	
	/** 支付宝费率（%） */
	@Excel(name = "支付宝费率（%）", type = Type.EXPORT)
	...
	public String toString() {
		return "AgentUserTraditionalPosInfo [id=" + id + ", manager_id=" + manager_id + ", user_id=" + user_id
				+ ", user_tel=" + user_tel + ", real_name=" + real_name + ", sn=" + sn + ", card_settle_price="
				+ card_settle_price + ", cloud_settle_price=" + cloud_settle_price + ", weixin_settle_price="
				+ weixin_settle_price + ", zhifubao_settle_price=" + zhifubao_settle_price + ", single_profit_rate="
				+ single_profit_rate + ", cash_back_rate=" + cash_back_rate + ", mer_cap_fee=" + mer_cap_fee
				+ ", state_status=" + state_status + ", activity_status=" + activity_status + ", del=" + del
				+ ", trade_status=" + trade_status + ", pos_id=" + pos_id + ", mer_id=" + mer_id + ", mer_name="
				+ mer_name + ", name=" + name + ", tel=" + tel + ", cash_back_type=" + cash_back_type
				+ ", cash_back_condition=" + cash_back_condition + ", cash_back_money=" + cash_back_money
				+ ", real_cash_back_money=" + real_cash_back_money + ", cash_back_status=" + cash_back_status
				+ ", credit_card_rate=" + credit_card_rate + ", cloud_flash_rate=" + cloud_flash_rate + ", weixin_rate="
				+ weixin_rate + ", zhifubao_rate=" + zhifubao_rate + ", scan_status=" + scan_status + ", act_status="
				+ act_status + ", act_user_id=" + act_user_id + ", act_date=" + act_date + ", trade_date=" + trade_date
