 ...
 */
@Controller
@RequestMapping("/deveagent/posPolicySet")
public class PosPolicySetController {
    ...
    public String sysPosPolicy(ModelMap mmap)
    {
        ...
        return prefix + "/posPolicySet";
    }

    @PostMapping("/setPolicy")
    @ResponseBody
    public R setPolicy(@RequestParam Map<String, Object> params){
        String pos_sns = String.valueOf(params.get("pos_sns"));
        String policy = String.valueOf(params.get("policy"));
        sysPosPolicyService.insertPolicySNInfo(policy,pos_sns,"","");
        return R.ok("success");
    }
    ...
    public TableDataInfo list(@RequestParam Map<String, Object> params)
    {
        ...
        startPage();
        //根据条件分页查询用户列表
        List<Map<String,Object>> list = sysPosPolicyService.selectUserPOSBelongList(params);
        //处理响应请求分页数据
