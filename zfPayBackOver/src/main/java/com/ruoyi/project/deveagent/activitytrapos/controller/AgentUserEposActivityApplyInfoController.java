 ...
 */
@Controller
@RequestMapping("/deveagent/userEposActivityApplyInfo")
public class AgentUserEposActivityApplyInfoController extends BaseController
{
    private String prefix = "deveagent/userEposActivityApplyInfo";
	
	@Autowired
	private AgentUserEposActivityApplyInfoService agentUserEposActivityApplyInfoService;
	...
	public TableDataInfo list(@RequestParam Map<String, Object> params)
	{
		...
		startPage();
		//根据条件分页查询用户列表
        List<Map<String, Object>> list = agentUserEposActivityApplyInfoService.getAgentUserTraposActivityApplyInfoList(params);
        //处理响应请求分页数据
    ...
    {
    	List<AgentUserTraposActivityApplyInfo> list = agentUserEposActivityApplyInfoService.selectAgentUserTraposActivityApplyInfoList(params);
    ...
    {
        mmap.put("applyInfo", agentUserEposActivityApplyInfoService.getAgentUserTraposActivityApplyInfoDetailById(id));
    ...
    {
        return agentUserEposActivityApplyInfoService.batchSysAuditUserTraposActivityApplyInfo(params);
    }
