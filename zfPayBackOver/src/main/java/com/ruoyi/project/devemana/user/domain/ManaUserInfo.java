 ...
 * @date 2019-05-17
 */
public class ManaUserInfo extends BaseEntity
{
	...
	public String toString() {
		return "ManaUserInfo [id=" + id + ", manager_id=" + manager_id + ", manager_login_name=" + manager_login_name
				+ ", manager_user_name=" + manager_user_name + ", rank=" + rank + ", user_tel=" + user_tel
