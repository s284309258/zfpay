...
public class CacheServiceAspect {
	...
	@Pointcut("@annotation(com.example.longecological.annotations.EnableCacheService)")
    ...
    public Object dealCacheService(ProceedingJoinPoint point) throws Throwable{
    	...
    	// 获取注解对象
    	EnableCacheService redis = method.getAnnotation(EnableCacheService.class);
    	//所有参数
     ...
     * 查询处理
     */
	private Object processQuery(ProceedingJoinPoint point, EnableCacheService redis, String cacheKey)
			throws Throwable {
