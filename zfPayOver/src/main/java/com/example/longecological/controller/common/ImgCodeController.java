...
public class ImgCodeController {
	...
	public R createImgCode(@SIGNOnly @RequestBody Map<String, Object> map) {
	 ...
	 */
	@ResponseBody
	@PostMapping("/createImgCodeWeb")
	public R createImgCodeWeb(@SIGNOnlyWeb @RequestBody Map<String, Object> map) {
		return imgCodeService.createImgCode(map);
	}
}
